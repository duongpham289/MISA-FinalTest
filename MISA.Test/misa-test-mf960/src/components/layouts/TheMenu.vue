<template>
  <div class="menu-container expand">
    <div class="logo-container">
        <a href="#" class="menu-container-option"></a>
        <a href="#" class="logo"><img src="../../assets/img/Logo_Module_TiengViet_White.66947422.svg" class="img-icon"></a>
    </div>
